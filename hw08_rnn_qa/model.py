...
class QA_RNN(nn.Module):
    def __init__(self, vocab_size, hidden_size=128, model="lstm", n_layers=1):
        ...
        # Draw the task of our word-based question-answering
        # Can you inialize this embedding with glove_100d?
        # download 100d or 300d in https://nlp.stanford.edu/projects/glove/    
        # maybe write a for-loop to initialize the embedding with glove_100d with corresponding words in your vocabulary with glove's embedding
        # write details and post code here
