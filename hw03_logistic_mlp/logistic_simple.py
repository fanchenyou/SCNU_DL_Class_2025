...
def get_BiNormal():
    ...
    mu1 = -1.2 * torch.ones(2)
    mu2 = 1.6 * torch.ones(2)

    sigma1 = torch.eye(2) * 0.7
    sigma2 = torch.eye(2) * 1.1
...
if __name__ == '__main__':
    ...
    train(X_train, X_test, y_train, y_test, optimizer, model=model)
